package com.ssrdi.co.id.myradboox.utility.ticketview;
...
public class TicketView extends View {
    ...
    private void generateShadow() {
        if (TicketUtils.isJellyBeanAndAbove() && !isInEditMode()) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mScallopRadius = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketScallopRadius, TicketUtils.dpToPx(20f, getContext()));
            ...
            mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketBorderWidth, TicketUtils.dpToPx(2f, getContext()));
            ...
            mDividerWidth = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerWidth, TicketUtils.dpToPx(2f, getContext()));
            ...
            mDividerDashLength = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerDashLength, TicketUtils.dpToPx(8f, getContext()));
            mDividerDashGap = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerDashGap, TicketUtils.dpToPx(4f, getContext()));
            mCornerType = typedArray.getInt(R.styleable.TicketView_ticketCornerType, CornerType.NORMAL);
            mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketCornerRadius, TicketUtils.dpToPx(4f, getContext()));
            mDividerPadding = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerPadding, TicketUtils.dpToPx(10f, getContext()));
            float elevation = 0f;
    ...
    public void setTicketElevation(float elevation) {
        if (!TicketUtils.isJellyBeanAndAbove()) {
    ...
    private void setShadowBlurRadius(float elevation) {
        ...
        float maxElevation = TicketUtils.dpToPx(24f, getContext());
